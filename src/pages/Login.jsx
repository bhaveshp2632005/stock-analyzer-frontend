...
import { BarChart3, Mail, Lock, Brain, Activity, Zap, Sun, Moon } from "lucide-react";
    ...
    <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",padding:"0 16px",
      ...
      <div style={{position:"relative",width:"100%",maxWidth:400,zIndex:10}}>
        ...
        <div style={{
          ...
          <h2 style={{margin:"0 0 4px",fontSize:19,fontWeight:800,textAlign:"center",color:t.textPrimary}}>Welcome Back</h2>
          ...
          <form onSubmit={handleSubmit}>
            {[{type:"email",name:"email",label:"Email",icon:<Mail size={13}/>,ph:"you@example.com"},
              {type:"password",name:"password",label:"Password",icon:<Lock size={13}/>,ph:"••••••••"}
            ].map(f=>(
          ...
          <p style={{textAlign:"center",fontSize:12,color:t.textMuted,marginTop:16}}>
            No account?{" "}
            <Link to="/signup" style={{color:"#34d399",fontWeight:600}}>Create Account</Link>
          </p>
        </div>
